"""Tests for the Sprint 0.5.0 readiness runner."""
...
from scripts.run_v050_readiness_stack import build_default_lanes
from scripts.run_v050_readiness_stack import _render_markdown_summary


class Sprint050ReadinessStackTests(unittest.TestCase):
  """Keep the Sprint 5 readiness schedule explicit and multi-strategy."""
  ...
  def test_markdown_summary_mentions_strategy_coverage(self) -> None:
      ...
      'lanes': [
        {
          ...
          'stdout_path': 'temp/fs5_readiness/pytest_baseline/stdout.txt',
          'stderr_path': 'temp/fs5_readiness/pytest_baseline/stderr.txt',
        },
        {
          ...
          'stdout_path': 'temp/fs5_readiness/empirical_review/stdout.txt',
          'stderr_path': 'temp/fs5_readiness/empirical_review/stderr.txt',
        },
      ],
    }
    ...
    self.assertIn('Sprint 0.5.0 readiness summary', markdown)
